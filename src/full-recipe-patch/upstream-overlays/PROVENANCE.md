...
This vendored copy additionally recognizes `FP8_PB_WO` in the block-FP8 MoE
branch of `modelopt.py`. NVIDIA's current official checkpoint identifies the
MTP experts with that enum; without it, vLLM cannot load the MTP head.
